...
const addressInput = document.getElementById("anddress")
...
function addToCart(name, price){
    ...
    if(existingItem){
        //Se o item ja existe aumenta so a quatidade + 1
...
addressInput.addEventListener("input", function(event){
    ...
    if(inputValue !== ""){
        addressInput.classList.remove("border-red-100")
        anddressWarn.classList.add("hidden")
    }
    //
})
...
checkoutBtn.addEventListener("click", function(){
    ...
    if(addressInput.value === ""){
        anddressWarn.classList.remove("hidden")
        addressInput.classList.add("border-red-100")
        return;
    }
